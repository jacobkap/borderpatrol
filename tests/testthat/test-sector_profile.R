...
load("sector_profile_2011_2017.rda")
test_data <- sector_profile_2011_2017

test_that("Equal number of sectors and years works", {
  expect_length(unique(test_data$fiscal_year), 7)
  expect_length(unique(test_data$sector), 24)
})


test_that("Correct years and sectors", {
  expect_equal(unique(test_data$fiscal_year), 2017:2011)
