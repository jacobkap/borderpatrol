...
save_as_zip("family_child_total_monthly_2000_2018",
            pattern = "family_child_total_monthly")
save_as_zip("other_than_mexico_apprehensions_2000_2018",
            pattern = "other_than_mexico_apprehensions")
save_as_zip("border_patrol_staffing_1992_2018",
            pattern = "border_patrol_staffing")
save_as_zip("nationwide_total_apprehensions_1925_2018",
            pattern = "nationwide_total_apprehensions")
save_as_zip("southwest_border_deaths_1998_2018",
            pattern = "southwest_border_deaths")
save_as_zip("southwest_border_apprehensions_1960_2018",
            pattern = "southwest_border_apprehensions")
save_as_zip("sector_profile_2011_2018",
            pattern = "sector_profile")
save_as_zip("apprehensions_seizures_stats_2011_2018",
